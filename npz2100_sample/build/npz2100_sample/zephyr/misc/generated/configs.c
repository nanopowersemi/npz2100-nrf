...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NANOPOWER_NPZ2100_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NPZ2100, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NPZ2100_INIT_PRIORITY, 80);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NPZ2100_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NPZ2100_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_NPZ2100_MODULE, 1);
